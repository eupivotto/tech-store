...
export const Cart = () => {
  const { cartItems, setCartItems, toggleCartVisibility } =
  ...
  const handleContinueToPayment = () => {
    ...
    navigate("/success", { state: { cartItems, totalAmount, orderData } });
  };
  ...
  return (
    <>
      <ContainerCart>
        ...
        />
        <CartItemsStyle>
          <ButtonCloseCart></ButtonCloseCart>
          {cartItems &&
            cartItems.map((cartItems: IDataProduct) => (
        ...
        <CartResume>
          <h3>
            Total dos Produtos R$ <span>{totalAmount}</span>
          </h3>
